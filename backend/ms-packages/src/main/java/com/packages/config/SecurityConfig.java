...
import com.packages.filter.GatewayHeaderAuthenticationFilter;
...
/**
 * Security Configuration for ms-packages.
 * 
...
public class SecurityConfig {
    ...
    /**
     * Configures the security filter chain for ms-packages.
     * 
     * Step-by-step:
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            // Custom entry point returns 401 instead of 403 for unauthenticated requests
