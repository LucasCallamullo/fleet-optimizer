...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http, 
        CustomAuthenticationEntryPoint entryPoint, CustomAccessDeniedHandler accessDeniedHandler
    ) {
        return http
            ...
            // Step 4: Write structured 401 / 403 responses directly.
            ...
            /*  .exceptionHandling(exceptionHandling -> exceptionHandling
                ...
                .authenticationEntryPoint((exchange, entryPoint) -> Mono.error(entryPoint))
            ) */
            .build();
    }
